...
<div class="credentials">
  ...
  <article class="credential-card">
    <div class="credential-card__badge credential-card__badge--vmware">
      <img src="/images/credentials/spring-certified-pro-2024-badge.png" alt="Badge officiel VMware Spring Certified Professional 2024" width="300" height="300" loading="lazy" decoding="async">
    </div>
    ...
    <div class="credential-card__meta">
      ...
      <a class="credential-card__verify no-arrow" href="https://www.credly.com/badges/531558dc-5679-4a97-8c48-6425c70bb727/public_url" rel="noopener" aria-label="Vérifier la certification Spring Pro">Verify ↗</a>
    </div>
  </article>

  <article class="credential-card">
    <div class="credential-card__badge">
      <img src="/images/credentials/google-cloud-associate-badge.png" alt="Badge officiel Google Cloud Certified Associate Cloud Engineer" width="521" height="521" loading="lazy" decoding="async">
    </div>
    <div class="credential-card__body">
    ...
    <div class="credential-card__meta">
      ...
      <a class="credential-card__verify no-arrow" href="https://www.credly.com/badges/e75f6dd6-fca0-4f52-a4d8-78b6a5abf472/public_url" rel="noopener" aria-label="Vérifier la certification GCP">Verify ↗</a>
    </div>
  </article>

  <article class="credential-card">
    <div class="credential-card__badge">
      <img src="/images/credentials/associate-android-developer-kotlin-badge.png" alt="Badge officiel Google Certified Associate Android Developer Kotlin" width="264" height="247" loading="lazy" decoding="async">
    </div>
    <div class="credential-card__body">
    ...
    <div class="credential-card__meta">
      ...
      <a class="credential-card__verify no-arrow" href="https://www.credential.net/eb8da596-af34-4fc8-aa0d-098da1472318#acc.94Kzeuyr" rel="noopener" aria-label="Vérifier la certification Android">Verify ↗</a>
    </div>
  </article>
...
<div class="tech-grid">
  <div class="tech-card"><span class="tech-card__label">Backend</span>Java · Spring Boot · Microservices</div>
  <div class="tech-card"><span class="tech-card__label">IA</span>Spring AI · Prompt engineering · Tool calling</div>
  <div class="tech-card"><span class="tech-card__label">Sécurité</span>Keycloak · Spring Security · OAuth2</div>
  <div class="tech-card"><span class="tech-card__label">Cloud</span>Google Cloud · Docker · Kubernetes</div>
  <div class="tech-card"><span class="tech-card__label">Mobile</span>Android · Kotlin · Firebase</div>
  <div class="tech-card"><span class="tech-card__label">Data</span>PostgreSQL · MongoDB · Talend ETL</div>
</div>

## Communauté GDG Libreville {#communaute}
...
Architecture d'applications Spring, audit de code, migration cloud, mise en place DevOps, refonte vers microservices. J'interviens sur des chantiers concrets, du diagnostic à la mise en production. *Stack : Spring Boot, Docker, Kubernetes, GCP.*
...
Interventions techniques au DevFest, dans les meetups GDG d'Afrique centrale, dans des écoles d'ingénieurs. Sujets : Spring AI, Google Cloud, architectures Spring résilientes, retours d'expérience sur l'IA générative dans des contextes publics. *Disponible en français et en anglais.*
